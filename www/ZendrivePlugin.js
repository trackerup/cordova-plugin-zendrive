...
exports.coolMethod = function (arg0, success, error) {
    exec(success, error, 'ZendrivePlugin', 'coolMethod', [arg0]);
};
...
Zendrive.registerForDelegateCallbacks = function(zendriveCallback) {
    ...
    exec(processStartOfDriveCallback, null, "ZendrivePlugin", "setProcessStartOfDriveDelegateCallback",
        [(null != processStartOfDriveCallback)]);

    var processEndOfDriveCallback = callbackNotNull ? zendriveCallback.processEndOfDrive :null;
    exec(processEndOfDriveCallback, null, "ZendrivePlugin", "setProcessEndOfDriveDelegateCallback",
    ...
    exec(processLocationDeniedCallback, null, "ZendrivePlugin", "setProcessLocationDeniedDelegateCallback",
...
Zendrive.setup = function(zendriveConfiguration, zendriveCallback, successCallback, errorCallback) {
    ...
    exec(setupSuccessCallback, setupFailureCallback, "ZendrivePlugin", "setup", [zendriveConfiguration]);
};
...
Zendrive.teardown = function() {
    exec(null, null,"ZendrivePlugin","teardown", []);
};
...
Zendrive.startDrive = function(driveTrackingId) {
    exec(null, null, "ZendrivePlugin", "startDrive", [driveTrackingId]);
};
...
Zendrive.getActiveDriveInfo = function(callback) {
    ...
    exec(activeDriveCallback, null, "ZendrivePlugin", "getActiveDriveInfo", []);
};
...
Zendrive.stopDrive = function(driveTrackingId) {
    exec(null, null,"ZendrivePlugin","stopDrive", [driveTrackingId]);
};
...
Zendrive.startSession = function(sessionId) {
    exec(null, null,"ZendrivePlugin","startSession", [sessionId]);
};
...
Zendrive.stopSession = function() {
    exec(null, null,"ZendrivePlugin","stopSession", []);
};
...
Zendrive.setDriveDetectionMode = function(driveDetectionMode) {
    exec(null, null, "ZendrivePlugin", "setDriveDetectionMode", [driveDetectionMode]);
};
